...
class CategoryPage extends StatefulWidget {
  const CategoryPage({super.key,this.enableFirebase = true,this.testMode = false, });
...
class _CategoryPageState extends State<CategoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: widget.testMode ? null : const SharedBottomNav(currentIndex: 2),    );
  }
}
